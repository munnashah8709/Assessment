...
2. on the second page  i am sending post to the dataDase 
  . again i am getting all the post from the database and listing on the page 
  . for each id am opening a comment input box and a post button on which if the user is commenting 
  . each comment on the post button i am sending the userid, postid and comment on the data base 
